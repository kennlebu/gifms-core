 ...
 *	@link 	https://github.com/partydroid/MySQL-Tools
 * 	@link 	https://mysqltools.org
 *	@version 02/Jan/2012
 */
CodeMirror
    .defineMode("mysql", function (config) {
        ...
        return {
            ...
            indent: function (state, textAfter) {
                ...
                if (!context) 
                    ...
                    return context.col + (closing
                        ? 0
                        : 1);
                else 
                    return context.indent + (closing
                        ? 0
                        : indentUnit);
                }
            };

...
<body style="font-family: arial;">
    ...
    <main>
        <div>
            <table style="width: 100%;font-size:13px;margin-top:20px;" cellspacing="0">
                <tbody>
                    <tr>
                        <td style="text-align:center;font-size:14px;" colspan="10" height="30"><span style="text-decoration: underline;"><strong><span style="color: #092d50; font-size: x-large; text-decoration: underline;">LOCAL PURCHASE ORDER </span></strong>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="7"></td>
                        <td colspan="1" bgcolor="#092d50" height="20"><strong><span style="color: #ffffff;font-size:12px;">Our REF:</span></strong></td>
                    ...
                    <tr>
                        <td style="font-size:13px;border-top: 1px solid #c0c0c0; border-bottom: 1px solid #c0c0c0; border-left: 1px solid #c0c0c0;" bgcolor="#092d50"><strong><span style="color: #ffffff;"> # </span></strong></td>
                        ...
                        <td style="font-size:13px;border: 1px solid #c0c0c0;" bgcolor="#092d50" colspan="2"><strong><span style="color: #ffffff;">Unit Price</span></strong></td>
                    ...
                    <tr>
                        ...
                        <td style="border-top: 1px solid #c0c0c0; border-bottom: 1px solid #c0c0c0; border-left: 1px solid #000000; border-right: 1px solid #000000;font-size:12px;" align="right" colspan="2">{{number_format($item->calculated_unit_price,2)}}</td>
            ...
            Yours sincerely<br/>
            The Clinton Health Access Initiative team.<br/><br/>
            <div style="display:inline-block">
                <div style="display:inline-block;margin-right:60px;"><br/>

  ...
  <main>
    <div>
      <table style="width: 100%;font-size: smaller;"  cellspacing="0">
        <tbody>
          <tr>
            <td style="text-align: center;" colspan="10"  height="30"><span style="text-decoration: underline;"><strong><span style="color: #092d50; font-size: x-large; text-decoration: underline;">PAYMENT VOUCHER</span></strong></span></td>
          </tr>          
        </tbody>
      </table>
    </div>

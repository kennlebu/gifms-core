...
Route::POST('/supplier-rates/table', 'SupplierRateApi@getRatesForTable')->middleware('jwt.auth');
...
Route::DELETE('/supplier-rate-term/{term_id}', 'SupplierRateApi@deleteSupplierRateTerm')->middleware('jwt.auth');
...
/**
 * POST getPaymentByPV
 * Summary: Get payment by PV
 * Notes: get payment by PV
 * Output-Formats: [application/json, application/xml]
 */
 ...
 * Output-Formats: [application/json, application/xml]
 */
Route::GET('/objectives', 'ReportsApi@getReportingObjectives')->middleware('jwt.auth');
...
Route::GET('/leave-request-summary', 'LeaveManagementApi@getLeaveSummary')->middleware('jwt.auth');
Route::GET('/leave-whos-out', 'LeaveManagementApi@getWhosOut')->middleware('jwt.auth');
// LeaveStatuses
...
Route::POST('inventory/issue-multiple', 'InventoryApi@issueMultipleInventory')->middleware('jwt.auth');

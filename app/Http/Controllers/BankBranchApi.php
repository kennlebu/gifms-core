...
class BankBranchApi extends Controller
{
    ...
    public function getBankBranchById($bank_branch_id)
    {
        ...
        try{
            ...
            $response =  ["error"=>"bank_branch could not be found"];
    ...
    /**
     * Operation bank_branchBranchesGet
     *
     * bank_branch_branches List.
     *
     *
     * @return Http response
     */
//     public function bank_branchBranchesGet()
//     {
//         $input = Request::all();
//         $response = BankBranchBranch::all();

//         //bank_branch_id
//         if(array_key_exists('bank_branch_id', $input)){

//             $bank_branch_id = (int) $input['bank_branch_id'];

//                 $response = BankBranchBranch::where("bank_branch_id",$bank_branch_id)->get();
